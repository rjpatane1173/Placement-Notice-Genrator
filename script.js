...
Pune.`;
    ...
    // Header section - Right next to logo
    const pageWidth = doc.internal.pageSize.getWidth();
    const headerLeft = 50; // Starts after logo
    
    doc.setFontSize(16);
    doc.setFont("helvetica", "bold");
    doc.text("Indira Group of Institutes", headerLeft, 20);
    
    doc.setFontSize(10);
    doc.setFont("helvetica", "normal");
    doc.text("Address: 123, XYZ Road, Pune, Maharashtra, India", headerLeft, 27);
    ...
    doc.setFontSize(16);
    doc.setFont("helvetica", "bold");
    doc.text("INDIRA PLACEMENT NOTICE", pageWidth / 2, 50, { align: 'center' });
    
    // Process notice text and remove "FINAL PLACEMENT NOTICE" line
    const formattedNotice = noticeText
        .replace(/\*/g, '')
        .split('\n')
        .filter(line => line.trim() !== '')
        .filter(line => !line.match(/FINAL PLACEMENT NOTICE/i)); // Remove this line
    ...
    doc.text("Generated by Indira Group of Institutes Placement Cell", pageWidth / 2, footerY, { align: 'center' });
